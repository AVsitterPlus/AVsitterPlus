/*
 * AVP_LockGuard - Attach LockGuard V2 chains
 *
...
//  SITTER:
//      The AVsitterPlus SITTER # the chain settings are for.
...
//      - If you're using props, you must include the "AVP_LockGuard-object" script in your props
